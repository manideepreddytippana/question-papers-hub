"""
Question processor — extraction, classification, and similarity analysis.

Moved from pdfstorage/question_processor.py without changes to the
core logic.  This module is used by analysis_service.py.
"""
...
class QuestionAnalyzer:
    ...
    def calculate_importance(self, questions, papers_count=1):
        """Calculate importance score for questions."""
        importance_scores = {}
